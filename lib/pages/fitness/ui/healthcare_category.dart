...
class HealthCareCategorySection extends StatefulWidget {
  const HealthCareCategorySection({
    Key? key,
  }) : super(key: key);

  @override
  State<HealthCareCategorySection> createState() => _CategorySectionState();
}

class _CategorySectionState extends State<HealthCareCategorySection> {
  @override
  void initState() {
    // TODO: implement initState
    HealthCareController.to.getCategory(0,1);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        SectionWithViewAll(
          horizontalPadding: 0,
          label: 'Fitness & Wellness Products',
          buttonLabel: 'See All',
          labelFontSize: 16,
          onTap: () {
