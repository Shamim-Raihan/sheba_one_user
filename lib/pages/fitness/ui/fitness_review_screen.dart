...
class FitnessReviewScreen extends StatefulWidget {
  const FitnessReviewScreen({Key? key}) : super(key: key);
  static String routeName = '/FitnessReviewScreen';

  @override
  State<FitnessReviewScreen> createState() => _DoctorReviewScreenState();
}

class _DoctorReviewScreenState extends State<FitnessReviewScreen> {
