...
class AppointmentDetailsOnlineScreen extends StatefulWidget {
  const AppointmentDetailsOnlineScreen({
    Key? key,
    required this.info,
  }) : super(key: key);
  ...
  @override
  State<AppointmentDetailsOnlineScreen> createState() => _AppointmentDetailsOnlineScreenState();
}

class _AppointmentDetailsOnlineScreenState extends State<AppointmentDetailsOnlineScreen> {
  @override
  Widget build(BuildContext context) {
    globalLogger.d(jsonDecode(widget.info.doctorPrescription!));
    return Scaffold(
      appBar: AppBar(
