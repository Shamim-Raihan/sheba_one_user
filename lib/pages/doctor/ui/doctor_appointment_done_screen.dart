...
class DoctorAppointmentDoneScreen extends StatelessWidget {
  const DoctorAppointmentDoneScreen({Key? key}) : super(key: key);
  static String routeName = '/DoctorAppointmentDoneScreen';
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        if (DoctorAppointmentController.to.appointmentType.value == AppointmentType.online) {
          Get.back();
          Get.back();
          Get.back();
          Get.back();
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ...
              const TitleText(
                title:
                    'Appoinment successfully Booked. You will receive a\nnotification and thedoctor you selected will contact you.',
                      ...
                      MainContainer(
                        ...
                        child: Column(
                          children: [
                                        ...
                                        Obx(
                                          () => RichText(
                                            text: TextSpan(
                                              ...
                                              children: [
                                                TextSpan(
                                                  text: (DoctorAppointmentController.to.appointmentSuccessInfo['id'] ??
                                                          '-')
                                                      .toString(),
                                                  style: const TextStyle(
                                                  ...
                                                  TextSpan(
                                                    text: DateFormat('dd-MM-yyyy').format(DateTime.parse(
                                                        DoctorAppointmentController
                                                            .to.appointmentSuccessInfo['created_at'])),
                                                    style: const TextStyle(
                                                      fontWeight: FontWeight.w600,
                                                    ),
                                                  ),
                            ...
                            if (DoctorAppointmentController.to.appointmentType.value == AppointmentType.home)
                              TitleText(
                                title: Get.arguments['info']['patient_address'],
                                color: Colors.black,
                                fontSize: 11,
                                fontWeight: FontWeight.normal,
                              ),
                            ...
                            InvoiceProductItem(
                              info: DoctorAppointmentController.to.getSingleDoctorDetails,
                            ),
                            ...
                            InvoiceProductItem(
                              from: 'consultation',
                              info: {
                                'type': DoctorAppointmentController.to.appointmentType.value == AppointmentType.clinic
                                    ? 'In-Clinic Consultation'
                                    : DoctorAppointmentController.to.appointmentType.value == AppointmentType.home
                                        ? 'Home Consultation'
                                        : 'Online Consultation',
                                'date': Get.arguments['data']['dmy'],
                                'time': Get.arguments['data']['start_time'],
                              },
                              imagePath: DoctorAppointmentController.to.appointmentType.value == AppointmentType.clinic
                                  ? 'clinic'
                                  : DoctorAppointmentController.to.appointmentType.value == AppointmentType.home
                                      ? 'home-doc'
                                      : 'online',
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                 Expanded(
                                                  child: TitleText(
                                                    title: 'Doctor Fees${DoctorAppointmentController.to.appointmentType.value == AppointmentType.online? ' (Paid)':''}: ',
                                                    color: Colors.black,
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.normal,
                                                ...
                                                Expanded(
                                                  child: TitleText(
                                                    title: (double.parse(DoctorAppointmentController.to.appointmentType.value ==
                                                        ...
                                                        : DoctorAppointmentController.to.appointmentType.value ==
                                                        AppointmentType.home
                                                        ? DoctorAppointmentController
                                                        .to.getSingleDoctorDetails.homeConsultFee!
                                                        : DoctorAppointmentController
                                                        .to.getSingleDoctorDetails.consultFee!) - (double.parse(
                                                        DoctorAppointmentController.to.appointmentType.value ==
                                                            AppointmentType.online
                                                            ? DoctorAppointmentController
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    ...
                                    child: TitleText(
                                      title:
                                          DoctorAppointmentController.to.appointmentType.value == AppointmentType.online
                                              ? '0.00'
                                              : (double.parse(DoctorAppointmentController
                                                          .to.getSingleDoctorDetails.consultFee!) -
                                                      (double.parse(DoctorAppointmentController
                                                              .to.getSingleDoctorDetails.consultFee!) *
                                                          5 /
                             ...
                             Align(
                              ...
                              child: Padding(
                                ...
                                child: TitleText(
                                  title: 'Payment Status: ${DoctorAppointmentController.to.appointmentType.value == AppointmentType.online? 'Paid':'Unpaid'}',
                                  color: Colors.black,
                                  fontSize: 12,
                                  fontWeight: FontWeight.w600,
                            ...
                            TitleText(
                              title: 'Payment Method: ${Get.arguments['ssl_res']['card_issuer']}',
                              color: Colors.black,
                              fontSize: 11,
                              fontWeight: FontWeight.w500,
                              textAlign: TextAlign.left,
                            ...
                            Padding(
                              ...
                              child: TitleText(
                                title:
                                    'You have paid ${double.parse(DoctorAppointmentController.to.appointmentType.value == AppointmentType.online ? DoctorAppointmentController.to.onlinePackageType.value == OnlinePackageType.audio ? DoctorAppointmentController.to.getSingleDoctorDetails.audioConsultFee! : DoctorAppointmentController.to.getSingleDoctorDetails.videoConsultFee! : DoctorAppointmentController.to.appointmentType.value == AppointmentType.home ? DoctorAppointmentController.to.getSingleDoctorDetails.homeConsultFee! : DoctorAppointmentController.to.getSingleDoctorDetails.consultFee!) * 5 / 100} tk of doctor fees as an service charge before confirming this appointment, and remaining ${double.parse(DoctorAppointmentController.to.appointmentType.value == AppointmentType.online ? DoctorAppointmentController.to.onlinePackageType.value == OnlinePackageType.audio ? DoctorAppointmentController.to.getSingleDoctorDetails.audioConsultFee! : DoctorAppointmentController.to.getSingleDoctorDetails.videoConsultFee! : DoctorAppointmentController.to.appointmentType.value == AppointmentType.home ? DoctorAppointmentController.to.getSingleDoctorDetails.homeConsultFee! : DoctorAppointmentController.to.getSingleDoctorDetails.consultFee!) - (double.parse(DoctorAppointmentController.to.appointmentType.value == AppointmentType.online ? DoctorAppointmentController.to.onlinePackageType.value == OnlinePackageType.audio ? DoctorAppointmentController.to.getSingleDoctorDetails.audioConsultFee! : DoctorAppointmentController.to.getSingleDoctorDetails.videoConsultFee! : DoctorAppointmentController.to.appointmentType.value == AppointmentType.home ? DoctorAppointmentController.to.getSingleDoctorDetails.homeConsultFee! : DoctorAppointmentController.to.getSingleDoctorDetails.consultFee!) * 5 / 100)} tk to doctor.',
                                color: Colors.black,
                                fontSize: 11,
                                fontWeight: FontWeight.w500,
                                textAlign: TextAlign.left,
...
class PdfPreviewPage extends StatelessWidget {
  ...
  Future<Uint8List> _generatePdf(PdfPageFormat format, String title) async {
    ...
    final consultationImage = await networkImage('https://shebaone.com/frontend_assets/img/icon/appointment.png');
          ...
          return [
            pw.Column(
              ...
              children: [
                    ...
                    children: [
                      pw.RichText(
                        text: pw.TextSpan(
                          ...
                          children: [
                            pw.TextSpan(
                              text: (DoctorAppointmentController.to.appointmentSuccessInfo['id'] ?? '-').toString(),
                              style: pw.TextStyle(
                          ...
                          children: [
                            pw.TextSpan(
                              text: DateFormat('dd-MM-yyyy').format(
                                  DateTime.parse(DoctorAppointmentController.to.appointmentSuccessInfo['created_at'])),
                              style: pw.TextStyle(
                                fontWeight: pw.FontWeight.bold,
                              ),
                            ),
                ...
                _text('Patient Details', fontSize: 12, fontWeight: pw.FontWeight.bold),
                pw.Padding(
                ...
                if (DoctorAppointmentController.to.appointmentType.value == AppointmentType.home)
                  _text(Get.arguments['info']['patient_address'], fontSize: 11),
                _divider(),
                            ...
                            child: pw.Column(
                              children: [
                                pw.Row(
                                  children: [
                                    pw.Expanded(
                                      child: _text('Doctor Fees${DoctorAppointmentController.to.appointmentType.value == AppointmentType.online? ' (Paid)':''}: ', fontSize: 12, textAlign: pw.TextAlign.right),
                                    ),
                                    pw.Expanded(
                                      child: _text(
                                          (double.parse(DoctorAppointmentController.to.appointmentType.value ==
                                              AppointmentType.online
                                              ? DoctorAppointmentController.to.onlinePackageType.value ==
                                              OnlinePackageType.audio
                                              ? DoctorAppointmentController
                                ...
                                pw.Row(
                                  children: [
                                    pw.Expanded(
                                      child:
                                          _text('Service Charge (paid): ', fontSize: 12, textAlign: pw.TextAlign.right),
                                    ),
                                    pw.Expanded(
                                      child: _text(
                                          (double.parse(
                  ...
                  children: [
                    ...
                    pw.Expanded(
                      ...
                      child: _text(
                        DoctorAppointmentController.to.appointmentType.value == AppointmentType.online
                            ? '0.00'
                            : (double.parse(DoctorAppointmentController.to.getSingleDoctorDetails.consultFee!) -
                                    (double.parse(DoctorAppointmentController.to.getSingleDoctorDetails.consultFee!) *
                                        5 /
                                        100))
                                .toStringAsFixed(2),
                ...
                pw.Align(
                  ...
                  child: pw.Padding(
                    ...
                    child: _text('Payment Status: ${DoctorAppointmentController.to.appointmentType.value == AppointmentType.online? 'Paid':'Unpaid'}', fontSize: 12, fontWeight: pw.FontWeight.bold),
                  ),
                ),
                _text('Payment Method: ${Get.arguments['ssl_res']['card_issuer']}',
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  _text(
                      from == 'consultation'
                          ? "Date: ${info['date']}"
                          : DoctorAppointmentController.to.getSpecializationName(info.specialization!),
                      fontSize: 11,
                      fontWeight: pw.FontWeight.bold),
                  if (from == 'consultation')
                    _text("Time: ${info['time']}", fontSize: 11, fontWeight: pw.FontWeight.bold),
                ],
              ),
            ),
            // pw.RichText(
