...
class _DoctorProfileScreenState extends State<DoctorProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Obx(
          () => DoctorAppointmentController.to.singleDoctorLoading.value
              ? const Center(
                  child: Waiting(),
                )
              : Column(
                  children: [
                        ...
                        child: Column(
                          ...
                          children: [
                                  ...
                                  ClipRRect(
                                    ...
                                    child: Obx(
                                      () => CustomNetworkImage(
                                        ...
                                        errorImagePath: 'assets/images/doctor-pp.png',
                                      ),
                                    ),
                                  ),
                                  Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Obx(
                                            () {
                                              return TitleText(
                                                title: DoctorAppointmentController.to.getSingleDoctorDetails.name!,
                                                fontSize: 18,
                                                color: Colors.black,
                                              );
                                            },
                                          ...
                                          Obx(
                                            () {
                                              return TitleText(
                                                title:
                                                    DoctorAppointmentController.to.getSingleDoctorDetails.edus!.isEmpty
                                                        ? ''
                                                        : DoctorAppointmentController
                                                            .to.getSingleDoctorDetails.edus![0].degree!,
                                                fontSize: 12,
                                                ...
                                                () {
                                                  return TitleText(
                                                    title: DoctorAppointmentController
                                                        .to.getSingleDoctorDetails.contactNo!,
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.normal,
                                                    color: Colors.black54,
                                                  );
                                          ...
                                          Obx(
                                            () {
                                              return TitleText(
                                                title: DoctorAppointmentController.to.getSingleDoctorDetails.chamber!,
                                                fontSize: 12,
                                                fontWeight: FontWeight.normal,
                                                color: Colors.black54,
                                              );
                                ...
                                children: [
                                  Obx(
                                    () => ShortInfo(
                                      position: -1,
                                      imagePath: 'patients',
                                      title: DoctorAppointmentController.to.getSingleDoctorDetails.patients!,
                                      label: 'Patients',
                                    ),
                                  ),
                                  Container(
                                  ...
                                  Obx(
                                    () => ShortInfo(
                                      ...
                                      title: DoctorAppointmentController.to.getSpecializationName(
                                          DoctorAppointmentController.to.getSingleDoctorDetails.specialization!),
                                    ),
                                  ),
                                  Container(
                                    height: 32,
                                  ...
                                  Obx(
                                    () => ShortInfo(
                                      ...
                                      label: 'Experience',
                                      title:
                                          '${DoctorAppointmentController.to.getSingleDoctorDetails.experience!} years',
                                    ),
                                  ),
                                ],
                              ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => TitleText(
                                      title:
                                          '${DoctorAppointmentController.to.getSingleDoctorDetails.name!} is the top most ${DoctorAppointmentController.to.getSpecializationName(DoctorAppointmentController.to.getSingleDoctorDetails.specialization!)} specialist in Dhaka Medical College Hospital. ${DoctorAppointmentController.to.getSingleDoctorDetails.gender!.toLowerCase() == 'male' ? 'He' : 'She'} achived several awards for ${DoctorAppointmentController.to.getSingleDoctorDetails.gender!.toLowerCase() == 'male' ? 'his' : 'her'} wonderful contribution in medical field. ${DoctorAppointmentController.to.getSingleDoctorDetails.gender!.toLowerCase() == 'male' ? 'He' : 'She'} is available for private consultation, online consultation and as well home visit.',
                                      color: Colors.black,
                                      fontSize: 11,
                                      fontWeight: FontWeight.normal,
                                      height: 2,
                            ...
                            Padding(
                              ...
                              child: Obx(() => DoctorAppointmentController.to.getUniqueAppointmentList.isEmpty
                                  ? const Text('No Slot Available')
                                  : SizedBox(
                                      height: 90,
                                      child: ListView.builder(
                                          itemCount: DoctorAppointmentController.to.getUniqueAppointmentList.length,
                                          scrollDirection: Axis.horizontal,
                                          itemBuilder: (_, index) {
                                            return AppointmentDateCard(
                                                info: DoctorAppointmentController.to.getUniqueAppointmentList[index],
                    ...
                    PrimaryButton(
                      ...
                      onPressed: () {
                        if(DoctorAppointmentController.to.getUniqueAppointmentList.isEmpty){
                          getSimpleDialog('Message', 'No Booking Slot Available for Booking');
                          // Fluttertoast.showToast(msg: 'No Booking Slot Available for Booking');
                        }else if(_activeIndex < 0){
                          Fluttertoast.showToast(msg: 'Please Select Booking Date First from Above!');

                        }else {
                          DoctorAppointmentController.to.setSelectedAppointmentSlot(
                              DoctorAppointmentController.to.mapAppointmentList[
                              DoctorAppointmentController.to.uniqueAppointmentList[_activeIndex].date]!);
                          Get.toNamed(DoctorBookAppointmentScreen.routeName);
                        }
                      },
                    ),
                  ],
