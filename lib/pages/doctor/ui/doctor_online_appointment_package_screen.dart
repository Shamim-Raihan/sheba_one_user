...
class DoctorOnlinePackagePackageScreen extends StatefulWidget {
  const DoctorOnlinePackagePackageScreen({Key? key}) : super(key: key);
  static String routeName = '/DoctorOnlinePackagePackageScreen';

  @override
  State<DoctorOnlinePackagePackageScreen> createState() =>
      _DoctorOnlinePackagePackageScreenState();
}

class _DoctorOnlinePackagePackageScreenState
    extends State<DoctorOnlinePackagePackageScreen> {
        ...
        children: [
                ...
                children: [
                  ...
                  Obx(
                    () => PackageTypeCard(
                      ...
                      price:
                          '৳ ${DoctorAppointmentController.to.getSingleDoctorDetails.videoConsultFee ?? '300.00'}',
                  ...
                  Obx(
                    () => PackageTypeCard(
                      ...
                      price:
                          '৳ ${DoctorAppointmentController.to.getSingleDoctorDetails.audioConsultFee ?? '200.00'}',
                      onTap: () {
                        _packageType = OnlinePackageType.audio;
                        setState(() {});
                      },
          ...
          PrimaryButton(
            ...
            onPressed: () {
              ...
              Get.toNamed(DoctorAppointmentDetailsScreen.routeName,
