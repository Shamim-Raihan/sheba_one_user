class DoctorAppointmentModel {
  ...
  DoctorAppointmentModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['home_slot'] != null) {
      homeSlot = <HomeSlot>[];
      json['home_slot'].forEach((v) {
        homeSlot!.add(HomeSlot.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (homeSlot != null) {
      data['home_slot'] = homeSlot!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class HomeSlot {
  ...
  HomeSlot.fromJson(Map<String, dynamic> json) {
    id = json['id'].toString() == 'null' ? '' : json['id'].toString();
    appointmentDate = json['appointment_date'].toString() == 'null' ? '' : json['appointment_date'].toString();
    appointmentTime = json['appointment_time'].toString() == 'null' ? '' : json['appointment_time'].toString();
    appointmentDay = json['appointment_day'].toString() == 'null' ? '' : json['appointment_day'].toString();
    appointmentStatus = json['appointment_status'].toString() == 'null' ? '' : json['appointment_status'].toString();
    doctorId = json['doctor_id'].toString() == 'null' ? '' : json['doctor_id'].toString();
    createdAt = json['created_at'].toString() == 'null' ? '' : json['created_at'].toString();
    updatedAt = json['updated_at'].toString() == 'null' ? '' : json['updated_at'].toString();
  }
